      ...
      >
        ...
        <DialogContent>
          {props.meetings.length ? (
              ...
              {!props.selectedMeeting || !props.selectedMeeting["join_url"] ? (
                ...
                <section className={"provision-access-current-controls"}>
                  <span>
                    ...
                    <p>
                      Meeting Name:{" "}
                      <strong>{props.selectedMeeting.topic}</strong>
                    </p>
                    <p>
                      Meeting Time:{" "}
                      <strong>
                        {DateTime.fromISO(
                          props.selectedMeeting.start_time
                        ).toLocaleString(DATETIME_MED)}
                      </strong>
                    </p>
                    <p>
                      ...
                      <strong>
                        {DateTime.fromISO(
                          props.selectedMeeting.created_at
                        ).toLocaleString(DATETIME_MED)}
                      </strong>
                    </p>
                  </span>
            ...
            <p>
              There are no meetings currently scheduled. You can make one{" "}
              <a href="https://zoom.us/meeting/schedule">here</a>.
            </p>
          )}
        </DialogContent>
        <DialogActions>
